...
export function AcademicCalendar({
  ...
  const marcosAcademicos = ['Início das Aulas', 'PROVA AV', 'PROVA AVS', 'Fim do Semestre', 'Férias', 'Matrícula', 'Rematrícula', 'Vestibular', 'ENADE', 'Colação de Grau'];
  ...
  return <div className="space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <Select value={formData.nome} onValueChange={value => setFormData({
                  ...formData,
                  nome: value
                })}>
                    <SelectTrigger>
                    ...
                    <SelectContent>
                      {marcosAcademicos.map(marco => <SelectItem key={marco} value={marco}>
                          {marco}
                        </SelectItem>)}
                    </SelectContent>
                  </Select>
              ...
              <div className="space-y-2">
                <Label htmlFor="safra">PERÍODO *</Label>
                <Input id="safra" value={formData.safra} onChange={e => setFormData({
                ...formData,
                safra: e.target.value
              })} placeholder="Ex: 25.2" />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Select value={formData.modalidade} onValueChange={value => setFormData({
                ...formData,
                modalidade: value as any
              })}>
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Select value={formData.maturidade} onValueChange={value => setFormData({
                ...formData,
                maturidade: value as any
              })}>
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                ...
                <div className="w-10 h-10 rounded border" style={{
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="space-y-2">
              <Label>Safra</Label>
              <Select value={filters.safra} onValueChange={value => setFilters({
              ...filters,
              safra: value
            })}>
                <SelectTrigger>
                ...
                <SelectContent>
                  ...
                  {Array.from(new Set(marcos.map(m => m.safra))).map(safra => <SelectItem key={safra} value={safra}>{safra}</SelectItem>)}
                </SelectContent>
              </Select>
            </div>
            ...
            <div className="space-y-2">
              ...
              <Select value={filters.modalidade} onValueChange={value => setFilters({
              ...filters,
              modalidade: value
            })}>
                <SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Select value={filters.maturidade} onValueChange={value => setFilters({
              ...filters,
              maturidade: value
            })}>
                <SelectTrigger>
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-2">
            {getFilteredMarcos().length > 0 ? getFilteredMarcos().map(marco => <div key={marco.id} className="flex items-center justify-between p-3 border rounded-lg">
                ...
                backgroundColor: marco.cor
                    ...
                    <Button variant="ghost" size="sm" onClick={() => onDeleteMarco(marco.id)} className="ml-auto text-destructive hover:text-destructive">
